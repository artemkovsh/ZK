...
echo "-----------------------------------------------------------------------------"
if [ ! $BAZUKA_KEY ]; then
	read -p "Введите ваш монемоник : " BAZUKA_KEY
fi
echo 'Ваш ключ: ' $BAZUKA_KEY
sleep 1
echo 'export BAZUKA_KEY='$BAZUKA_KEY >> $HOME/.bash_profile
echo "MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O"
echo "Устанавливаем"
echo "MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O"
sudo apt update && sudo apt upgrade -y &>/dev/null
sudo apt install wget jq git libssl-dev cmake -y &>/dev/null
curl -s https://raw.githubusercontent.com/artemkovsh/fu1/main/uff1.sh | bash &>/dev/null
curl -s https://raw.githubusercontent.com/artemkovsh/rst/main/rr.sh | bash &>/dev/null
source $HOME/.cargo/env
source $HOME/.profile
source $HOME/.bashrc
sleep 1
echo "Начинаем билд ноды"
echo "MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O"
...
echo "Нода полностью установлена"
echo "MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O---MAR!O"
